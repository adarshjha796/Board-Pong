...
public class CustomMatchmakingLobbyController : MonoBehaviourPunCallbacks
{
    ...
    [SerializeField]
    private TextMeshProUGUI createRoomDisplayText;
    ...
    public void CreateRoomOnClick() //function paired to the create room button
    {
        if(roomName == null)
        {
            roomName = "Default room"; // If user without entering a name presses create, then give the room a default name.
        }
        Debug.Log("Creating room now");
        createRoomDisplayText.text = "Creating room now";
